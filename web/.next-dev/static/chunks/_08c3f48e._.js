...
function FamilyRequestsWorkspace() {
    ...
    const [undoingMergeAuditLogId, setUndoingMergeAuditLogId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        try {
            ...
            setReviewState((current)=>{
                ...
                for (const request of rows){
                    ...
                    var _existing_role, _request_targetPerson_id, _ref, _ref1, _existing_mappingMode, _existing_relationType, _existing_primaryContactSource, _existing_mergeConfirmed;
                    next[request.id] = {
                        role: (_existing_role = existing === null || existing === void 0 ? void 0 : existing.role) !== null && _existing_role !== void 0 ? _existing_role : request.requestedRole,
                        personId: (_ref1 = (_ref = (_request_targetPerson_id = (_request_targetPerson = request.targetPerson) === null || _request_targetPerson === void 0 ? void 0 : _request_targetPerson.id) !== null && _request_targetPerson_id !== void 0 ? _request_targetPerson_id : existing === null || existing === void 0 ? void 0 : existing.personId) !== null && _ref !== void 0 ? _ref : (_people_ = people[0]) === null || _people_ === void 0 ? void 0 : _people_.id) !== null && _ref1 !== void 0 ? _ref1 : "",
                        mappingMode: (_existing_mappingMode = existing === null || existing === void 0 ? void 0 : existing.mappingMode) !== null && _existing_mappingMode !== void 0 ? _existing_mappingMode : "relation",
                        relationType: (_existing_relationType = existing === null || existing === void 0 ? void 0 : existing.relationType) !== null && _existing_relationType !== void 0 ? _existing_relationType : "child",
                        primaryContactSource: (_existing_primaryContactSource = existing === null || existing === void 0 ? void 0 : existing.primaryContactSource) !== null && _existing_primaryContactSource !== void 0 ? _existing_primaryContactSource : "requester",
                        mergeConfirmed: (_existing_mergeConfirmed = existing === null || existing === void 0 ? void 0 : existing.mergeConfirmed) !== null && _existing_mergeConfirmed !== void 0 ? _existing_mergeConfirmed : false
                    };
                }
                return next;
            });
    ...
    const reviewRequest = async (requestId, decision)=>{
        ...
        try {
            ...
            if (decision === "approved" && !(state === null || state === void 0 ? void 0 : state.personId)) {
                setRequestsMessage("Select a family member profile before approving this request.");
                return;
            }
            if (decision === "approved" && !(state === null || state === void 0 ? void 0 : state.mappingMode)) {
                setRequestsMessage("Choose mapping mode before approving this request.");
                return;
            }
            if (decision === "approved" && (state === null || state === void 0 ? void 0 : state.mappingMode) === "same_person" && !state.mergeConfirmed) {
            ...
            const response = await fetch("/api/families/".concat(selectedFamily.id, "/join-requests/").concat(requestId, "/review"), {
                ...
                body: JSON.stringify({
                    ...
                    mappingMode: (state === null || state === void 0 ? void 0 : state.mappingMode) || undefined,
                    relationType: (state === null || state === void 0 ? void 0 : state.mappingMode) === "relation" ? state === null || state === void 0 ? void 0 : state.relationType : undefined,
                    primaryContactSource: (state === null || state === void 0 ? void 0 : state.mappingMode) === "same_person" ? state === null || state === void 0 ? void 0 : state.primaryContactSource : undefined
                })
            });
            const payload = await response.json();
            if (!response.ok) {
    ...
    const undoMerge = async (mergeAuditLogId)=>{
        ...
        setRequestsMessage("");
        try {
            const response = await fetch("/api/families/".concat(selectedFamily.id, "/person-merges/").concat(mergeAuditLogId, "/undo"), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                }
            ...
            if (!response.ok) {
                var _payload_error;
                throw new Error((_payload_error = payload.error) !== null && _payload_error !== void 0 ? _payload_error : "Unable to undo merge.");
            }
                                ...
                                children: [
                                    ...
                                    request.status === "pending" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    state.mappingMode === "relation" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].field,
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    state.mappingMode === "same_person" && numbersDiffer ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].field,
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            state.mappingMode === "same_person" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].field,
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: [
                                            ...
                                            request.status === "approved" && request.mergeAuditLogId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                type: "button",
                                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].secondaryButton,
...
_s(FamilyRequestsWorkspace, "F6VpIPKuzYkCFmYZkJf3c0vp0yw=", false, function() {
    return [
...
//# sourceMappingURL=_08c3f48e._.js.map
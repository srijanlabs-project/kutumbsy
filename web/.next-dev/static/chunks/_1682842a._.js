...
const buildRelationshipGraph = (relationships)=>{
    ...
    for (const [parentId, children] of parentToChildren.entries()){
        ...
        if (!(spouses === null || spouses === void 0 ? void 0 : spouses.size)) {
            continue;
        }
...
const rowLabel = (level)=>{
    if (level < 0) {
        return Math.abs(level) === 1 ? "Parents / Guardians" : "".concat(Math.abs(level), " generations above");
    }
    if (level === 0) {
        return "Same generation";
    }
    return level === 1 ? "Children / Wards" : "".concat(level, " generations below");
};
const descriptorForNode = (node)=>{
    ...
    if (node.level < 0) {
        return "".concat(Math.abs(node.level), " generations above");
    }
    if (node.level > 0) {
        return "".concat(node.level, " generations below");
    }
    return "Same generation";
};
function FamilyTree(param) {
    ...
    _s();
    const [generationDepth, setGenerationDepth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const treeNodes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FamilyTree.useMemo[treeNodes]": ()=>buildTreeNodes(selectedPersonId, relationships, generationDepth)
    }["FamilyTree.useMemo[treeNodes]"], [
        selectedPersonId,
        relationships,
        generationDepth
    ]);
    const groupedLevels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FamilyTree.useMemo[groupedLevels]": ()=>{
            var _levels_get;
            ...
            for (const node of treeNodes.values()){
                ...
                var _levels_get1;
                const levelNodes = (_levels_get1 = levels.get(node.level)) !== null && _levels_get1 !== void 0 ? _levels_get1 : [];
                levelNodes.push({
                    person,
                    node
                });
            ...
            for (const levelNodes of levels.values()){
                levelNodes.sort({
                    "FamilyTree.useMemo[groupedLevels]": (left, right)=>left.person.fullName.localeCompare(right.person.fullName)
                }["FamilyTree.useMemo[groupedLevels]"]);
            }
            const above = Array.from(levels.entries()).filter({
                "FamilyTree.useMemo[groupedLevels].above": (param)=>{
                    let [level] = param;
                    return level < 0;
                }
            }["FamilyTree.useMemo[groupedLevels].above"]).sort({
                "FamilyTree.useMemo[groupedLevels].above": (left, right)=>left[0] - right[0]
            }["FamilyTree.useMemo[groupedLevels].above"]);
            var _levels_get_filter;
            const same = (_levels_get_filter = (_levels_get = levels.get(0)) === null || _levels_get === void 0 ? void 0 : _levels_get.filter({
                "FamilyTree.useMemo[groupedLevels]": (item)=>item.person.id !== selectedPersonId
            }["FamilyTree.useMemo[groupedLevels]"])) !== null && _levels_get_filter !== void 0 ? _levels_get_filter : [];
            const below = Array.from(levels.entries()).filter({
                "FamilyTree.useMemo[groupedLevels].below": (param)=>{
                    let [level] = param;
                    return level > 0;
                }
            }["FamilyTree.useMemo[groupedLevels].below"]).sort({
                "FamilyTree.useMemo[groupedLevels].below": (left, right)=>left[0] - right[0]
            }["FamilyTree.useMemo[groupedLevels].below"]);
            return {
                above,
                same,
                below
        ...
        "FamilyTree.useCallback[buildExportSvg]": ()=>{
            ...
            for (const [level, nodes] of groupedLevels.above){
                rows.push({
                    ...
                    items: nodes.map({
                        "FamilyTree.useCallback[buildExportSvg]": (param)=>{
                            let { person, node } = param;
                            return {
                                person,
                ...
                items: [
                    {
                        ...
                        descriptor: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRelationLabel"])(selectedPerson),
                        isFocus: true
                    }
                ]
            });
            ...
            const maxCols = Math.max(1, ...rows.map({
            ...
            const focusRowIndex = rows.findIndex({
                "FamilyTree.useCallback[buildExportSvg].focusRowIndex": (row)=>row.items.some({
                        "FamilyTree.useCallback[buildExportSvg].focusRowIndex": (item)=>item.isFocus
                    }["FamilyTree.useCallback[buildExportSvg].focusRowIndex"])
            }["FamilyTree.useCallback[buildExportSvg].focusRowIndex"]);
            const rowCenters = rows.map({
                "FamilyTree.useCallback[buildExportSvg].rowCenters": (row, rowIndex)=>{
            ...
            }["FamilyTree.useCallback[buildExportSvg].rowCenters"]);
            const lineElements = [];
            const nodeElements = [];
            for (const rowMeta of rowCenters){
                const { row, rowIndex, startX, y } = rowMeta;
                nodeElements.push('<text x="'.concat(startX, '" y="').concat(y - 10, '" fill="#6f5a42" font-size="12" font-family="Arial, sans-serif">').concat(escapeXml(row.title), "</text>"));
                row.items.forEach({
                    "FamilyTree.useCallback[buildExportSvg]": (item, itemIndex)=>{
                        ...
                        nodeElements.push('<rect x="'.concat(x, '" y="').concat(y, '" width="').concat(cardWidth, '" height="').concat(cardHeight, '" rx="14" ry="14" fill="').concat(fill, '" stroke="').concat(stroke, '" stroke-width="1.4" />'));
                        nodeElements.push('<text x="'.concat(x + 14, '" y="').concat(y + 34, '" fill="').concat(nameColor, '" font-size="18" font-weight="700" font-family="Georgia, serif">').concat(escapeXml(item.person.fullName), "</text>"));
                        nodeElements.push('<text x="'.concat(x + 14, '" y="').concat(y + 60, '" fill="').concat(metaColor, '" font-size="12.5" font-family="Arial, sans-serif">').concat(escapeXml(item.descriptor), "</text>"));
                        if (focusRowIndex >= 0 && rowIndex !== focusRowIndex) {
                            ...
                            lineElements.push('<line x1="'.concat(focusX, '" y1="').concat(focusY, '" x2="').concat(targetX, '" y2="').concat(targetY, '" stroke="#8bb08f" stroke-width="1.2" opacity="0.55" />'));
                        }
                    }
                }["FamilyTree.useCallback[buildExportSvg]"]);
            }
            return '<svg xmlns="http://www.w3.org/2000/svg" width="'.concat(width, '" height="').concat(height, '" viewBox="0 0 ').concat(width, " ").concat(height, '">\n      <rect x="0" y="0" width="').concat(width, '" height="').concat(height, '" fill="#f8f2e6"/>\n      ').concat(lineElements.join(""), "\n      ").concat(nodeElements.join(""), "\n    </svg>");
        }
    }["FamilyTree.useCallback[buildExportSvg]"], [
        groupedLevels.above,
        groupedLevels.below,
    ...
    const renderNode = (person, node)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeNode, " ").concat(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeNodeLinked, " ").concat(selectedPersonId === person.id ? __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeNodeActive : ""),
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    type: "button",
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].cardButton,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGenerationLabel"])(person)
                        }, void 0, false, {
                            fileName: "[project]/app/tenant/workspace/sections/FamilyTree.tsx",
                            lineNumber: 555,
                            columnNumber: 9
    ...
    const renderBand = (level, levelNodes)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBand,
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBandHeader,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBandConnector,
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBandStem
                        }, void 0, false, {
                            fileName: "[project]/app/tenant/workspace/sections/FamilyTree.tsx",
                            lineNumber: 567,
                            columnNumber: 9
                        }, this),
                        levelNodes.length > 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBandBranch,
                            style: {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBandBody, " ").concat(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBandBodyConnected),
                    children: levelNodes.map((param)=>{
                        let { person, node } = param;
                        return renderNode(person, node);
                    })
                }, void 0, false, {
                    fileName: "[project]/app/tenant/workspace/sections/FamilyTree.tsx",
                    lineNumber: 575,
    ...
    const renderTreeCanvas = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: treeNodes.size > 1 || selectedPerson ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ref: viewportRef,
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeCanvas,
                        children: [
                            groupedLevels.above.map((param)=>{
                                let [level, levelNodes] = param;
                                return renderBand(level, levelNodes);
                            }),
                            groupedLevels.above.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeFocusConnector,
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeFocusStem
                                }, void 0, false, {
                                    fileName: "[project]/app/tenant/workspace/sections/FamilyTree.tsx",
                                    lineNumber: 604,
                                    columnNumber: 19
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].focusNode,
                                children: selectedPerson ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRelationLabel"])(selectedPerson)
                                        }, void 0, false, {
                                            fileName: "[project]/app/tenant/workspace/sections/FamilyTree.tsx",
                                            lineNumber: 612,
                                            columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGenerationLabel"])(selectedPerson)
                                        }, void 0, false, {
                                            fileName: "[project]/app/tenant/workspace/sections/FamilyTree.tsx",
                                            lineNumber: 613,
                                            columnNumber: 21
                            ...
                            groupedLevels.same.length || groupedLevels.below.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeFocusConnector,
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeFocusStem
                                }, void 0, false, {
                            ...
                            groupedLevels.same.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBand,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBandHeader,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeBandBody,
                                        children: groupedLevels.same.map((param)=>{
                                            let { person, node } = param;
                                            return renderNode(person, node);
                                        })
                                    }, void 0, false, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                children: [
                                    ...
                                    memberCount || relationshipCount ? " ".concat(memberCount !== null && memberCount !== void 0 ? memberCount : people.length, " members - ").concat(relationshipCount !== null && relationshipCount !== void 0 ? relationshipCount : relationships.length, " relationships") : ""
                                ]
                            }, void 0, true, {
                                fileName: "[project]/app/tenant/workspace/sections/FamilyTree.tsx",
                                lineNumber: 653,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].treeSelectGroup,
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(FamilyTree, "2vf36zs08Ok/hO+khlRBvH2h2kA=");
_c = FamilyTree;
var _c;
    ...
    if (compact) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].profileCompactChips,
                    children: related.length ? related.slice(0, 4).map((relationship)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: [
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRelationLabel"])(person),
                            " | ",
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGenerationLabel"])(person)
                        ]
                    }, void 0, true, {
                        fileName: "[project]/app/tenant/workspace/sections/PersonSpotlight.tsx",
                        lineNumber: 119,
...
function WorkspaceEmptyState(param) {
    let { title, message, primaryLabel = "Open Family Access", primaryHref = "/platform/auth" } = param;
...
"[project]/app/tenant/workspace/members/[personId]/QuickAddRelative.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const buildGenerationForRelative = (anchorPerson, relationType)=>{
    const currentGeneration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGenerationLabel"])(anchorPerson);
    switch(relationType){
        case "child":
...
function QuickAddRelative(param) {
    let { familyId, anchorPerson, relationships, canEdit, onCreated } = param;
    _s();
    ...
    const [message, setMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [createdPersonId, setCreatedPersonId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const relationLabel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "QuickAddRelative.useMemo[relationLabel]": ()=>{
    ...
    const relationshipGroups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "QuickAddRelative.useMemo[relationshipGroups]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildRelationshipTree"])(relationships, anchorPerson.id)
    }["QuickAddRelative.useMemo[relationshipGroups]"], [
        relationships,
        anchorPerson.id
    ]);
    const existingRelated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "QuickAddRelative.useMemo[existingRelated]": ()=>{
            var _relationshipGroups_find;
            var _relationshipGroups_find_items;
            return (_relationshipGroups_find_items = (_relationshipGroups_find = relationshipGroups.find({
                "QuickAddRelative.useMemo[existingRelated]": (group)=>group.label === relationCopy[form.relationType].groupLabel
            }["QuickAddRelative.useMemo[existingRelated]"])) === null || _relationshipGroups_find === void 0 ? void 0 : _relationshipGroups_find.items) !== null && _relationshipGroups_find_items !== void 0 ? _relationshipGroups_find_items : [];
        }
    }["QuickAddRelative.useMemo[existingRelated]"], [
        relationshipGroups,
        form.relationType
    ]);
    const duplicateName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "QuickAddRelative.useMemo[duplicateName]": ()=>{
            const normalizedName = form.fullName.trim().toLowerCase();
            if (!normalizedName) {
                return null;
            }
            var _existingRelated_find;
            return (_existingRelated_find = existingRelated.find({
                "QuickAddRelative.useMemo[duplicateName]": (person)=>person.fullName.trim().toLowerCase() === normalizedName
            }["QuickAddRelative.useMemo[duplicateName]"])) !== null && _existingRelated_find !== void 0 ? _existingRelated_find : null;
        }
    }["QuickAddRelative.useMemo[duplicateName]"], [
        existingRelated,
        form.fullName
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            ...
            const personResponse = await fetch("/api/families/".concat(familyId, "/people"), {
                method: "POST",
                headers: {
            ...
            if (!personResponse.ok || !((_personPayload_data = personPayload.data) === null || _personPayload_data === void 0 ? void 0 : _personPayload_data.id)) {
                var _personPayload_error;
                throw new Error((_personPayload_error = personPayload.error) !== null && _personPayload_error !== void 0 ? _personPayload_error : "Unable to create the new family member.");
            }
            const relationshipResponse = await fetch("/api/families/".concat(familyId, "/relationships"), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            if (!relationshipResponse.ok) {
                var _relationshipPayload_error;
                throw new Error((_relationshipPayload_error = relationshipPayload.error) !== null && _relationshipPayload_error !== void 0 ? _relationshipPayload_error : "Unable to create the relationship.");
            }
            await onCreated(personPayload.data.id);
            setForm(emptyForm);
            setCreatedPersonId(personPayload.data.id);
            setMessage("".concat(relationLabel, " added successfully and linked to ").concat(anchorPerson.fullName, "."));
        } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].quickAddChooser,
                children: Object.keys(relationCopy).map((relationType)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        type: "button",
                        className: "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].quickAddChoice, " ").concat(form.relationType === relationType ? __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].quickAddChoiceActive : ""),
                        onClick: ()=>{
                            setForm((current)=>({
                                    ...current,
                                    relationType
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].quickAddContext,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
            ...
            existingRelated.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].quickAddExisting,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                        children: [
                            "Already linked ",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].quickAddExistingList,
                        children: existingRelated.map((person)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].relationshipChip,
                                children: person.fullName
                            }, person.id, false, {
                                fileName: "[project]/app/tenant/workspace/members/[personId]/QuickAddRelative.tsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].formStack,
                onSubmit: handleSubmit,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].formGrid,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].fieldBlock,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        placeholder: "New ".concat(relationLabel.toLowerCase(), " name"),
                                        required: true
                                    }, void 0, false, {
                                        fileName: "[project]/app/tenant/workspace/members/[personId]/QuickAddRelative.tsx",
                                        lineNumber: 232,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].linkButton,
                        disabled: submitting,
                        children: submitting ? "Adding..." : "Add ".concat(relationLabel)
                    }, void 0, false, {
                        fileName: "[project]/app/tenant/workspace/members/[personId]/QuickAddRelative.tsx",
                        lineNumber: 266,
                        columnNumber: 9
                    }, this),
                    duplicateName ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].inlineWarning,
                        children: [
                            "A ",
                            relationLabel.toLowerCase(),
                            " named ",
                    ...
                    message ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].inlineMessage,
                        children: message
                    }, void 0, false, {
                        fileName: "[project]/app/tenant/workspace/members/[personId]/QuickAddRelative.tsx",
                        lineNumber: 274,
                    ...
                    createdPersonId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].quickAddSuccessActions,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].inlineLink,
                                href: "/family-space/members/".concat(createdPersonId),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].inlineButton,
                                onClick: ()=>{
                                    setMessage("");
                                    setCreatedPersonId(null);
                                },
...
_s(QuickAddRelative, "2/EtrQifyVAb+Bk+h7YJnaWLB0w=");
_c = QuickAddRelative;
var _c;
__turbopack_context__.k.register(_c, "QuickAddRelative");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostLoginShell$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].sidebarCard,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
function FamilyWorkspaceShell(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostLoginShell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PostLoginShell"], {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].eventRail,
        ...
        children: [
            ...
            topMessage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$workspace$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].inlineStatus,
                children: topMessage
            }, void 0, false, {
                fileName: "[project]/app/tenant/workspace/sections/FamilyWorkspaceShell.tsx",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$members$2f5b$personId$5d2f$QuickAddRelative$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/tenant/workspace/members/[personId]/QuickAddRelative.tsx [app-client] (ecmascript)");
...
function MemberProfileWorkspace(param) {
    let { personId } = param;
    _s();
    const { session, activeWorkspaceId, families, people, relationships, selectedPersonId, setSelectedPersonId, refresh, loading, message } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$useTenantWorkspaceData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTenantWorkspaceData"])(personId);
    var _families_find;
    ...
    const activeMembership = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MemberProfileWorkspace.useMemo[activeMembership]": ()=>{
            ...
            return (_session_memberships_find = session === null || session === void 0 ? void 0 : session.memberships.find({
                "MemberProfileWorkspace.useMemo[activeMembership]": (membership)=>membership.familyId === activeWorkspaceId
            }["MemberProfileWorkspace.useMemo[activeMembership]"])) !== null && _session_memberships_find !== void 0 ? _session_memberships_find : null;
        }
    }["MemberProfileWorkspace.useMemo[activeMembership]"], [
        session,
        activeWorkspaceId
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$sections$2f$FamilyWorkspaceShell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FamilyWorkspaceShell"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$tenant$2f$workspace$2f$members$2f5b$personId$5d2f$QuickAddRelative$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QuickAddRelative"], {
                    familyId: selectedFamily.id,
                    anchorPerson: selectedPerson,
                    relationships: relationships,
                    canEdit: (activeMembership === null || activeMembership === void 0 ? void 0 : activeMembership.role) === "admin" || (activeMembership === null || activeMembership === void 0 ? void 0 : activeMembership.role) === "editor",
                    onCreated: refresh
                }, void 0, false, {
                    fileName: "[project]/app/tenant/workspace/members/[personId]/workspace.tsx",
                    lineNumber: 85,
...
_s(MemberProfileWorkspace, "p6MnosI5oOtTzy3XFXISf14H5Fg=", false, function() {
    return [
...
//# sourceMappingURL=_1682842a._.js.map
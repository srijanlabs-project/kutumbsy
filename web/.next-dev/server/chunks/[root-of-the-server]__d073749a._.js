module.exports = [
"[project]/.next-internal/server/app/api/auth/verify-otp/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function POST(request) {
    try {
        const inputPayload = await request.json().catch(()=>null);
        ...
        const responsePayload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f$shared$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readJsonSafely"])(response) ?? {
            error: "empty response from auth service"
        };
        const nextResponse = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(responsePayload, {
            status: response.status
        });
        if (response.ok && responsePayload.data?.token) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f$shared$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeSessionCookie"])(nextResponse, responsePayload.data.token);
        }
        return nextResponse;
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d073749a._.js.map
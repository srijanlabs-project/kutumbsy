module.exports = [
"[project]/.next-internal/server/app/api/families/[id]/people/[personId]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/families/[id]/people/[personId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const proxy = async (request, path, init)=>{
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Unable to reach family service",
            detail: message
        }, {
            status: 502
        });
...
async function PATCH(request, context) {
    ...
    return proxy(request, `/api/v1/families/${id}/people/${personId}`, {
        method: "PATCH",
        body
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2de1f3d._.js.map
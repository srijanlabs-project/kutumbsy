...
const isSymmetricType = (relationshipType)=>relationshipType === "spouse_of" || relationshipType === "divorced_from" || relationshipType === "separated_from" || relationshipType === "widowed_from" || relationshipType === "sibling_of";
...
const inferMetadataRelationships = (people, relationships)=>{
    ...
    for (const person of people){
        ...
        if ([
            ...
            addInferred(anchor, person, "sibling_of");
        }
    }
    return [
        ...relationships,
...
function useTenantWorkspaceData(initialPersonId) {
    ...
    const load = async (targetPersonId)=>{
        ...
        try {
            ...
            const nextRelationships = relationshipPayload.data ?? [];
...
//# sourceMappingURL=_d82372e3._.js.map
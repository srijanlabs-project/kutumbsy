module.exports = [
"[project]/.next-internal/server/app/api/auth/register-user/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/auth/register-user/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f$shared$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readJsonSafely"])(response) ?? {
            error: "empty response from auth service"
        };
        const nextResponse = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(payload, {
            status: response.status
        });
        if (response.ok && payload.data?.token) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f$shared$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeSessionCookie"])(nextResponse, payload.data.token);
        }
        return nextResponse;
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__94e8c98f._.js.map